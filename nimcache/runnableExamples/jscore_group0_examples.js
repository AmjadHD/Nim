...
failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(9, 3) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(0, 3, 4) == @[\'d\', \'b\', \'c\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u14(new Uint8Array([97, 98, 99, 100, 101]).copyWithin(1, 3), [97, 100, 101, 100, 101]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(10, 3) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(1, 3) == @[\'a\', \'d\', \'e\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(new Int32Array([1, 2, 3, 4, 5]).copyWithin((-2)), [1, 2, 3, 1, 2]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(11, 3) `[1, 2, 3, 4, 5].copyWithin(-2) == @[1, 2, 3, 1, 2]` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3), [4, 5, 3, 4, 5]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(12, 3) `[1, 2, 3, 4, 5].copyWithin(0, 3) == @[4, 5, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3, 4), [4, 2, 3, 4, 5]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(13, 3) `[1, 2, 3, 4, 5].copyWithin(0, 3, 4) == @[4, 2, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(new Int32Array([1, 2, 3, 4, 5]).copyWithin((-2), (-3), (-1)), [1, 2, 3, 3, 4]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(14, 3) `[1, 2, 3, 4, 5].copyWithin(-2, -3, -1) == @[1, 2, 3, 3, 4]` "));
}
...
F.line = 145;
failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_2.nim(10, 3) `arrai.shift() == 1` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(arrai_721420295[0], [2, 3]))) {
F.line = 145;
failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_2.nim(11, 3) `arrai == @[2, 3]` "));
}
