...
Label1: {
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(13, 5) `header.hasKey(\"key\")` "));
  }
  
  if (!(HEX3DHEX3D__jsheaders95examples951_u13(Array.from(header_654311427.keys()), ["key"]))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(14, 5) `header.keys() == @[\"key\".cstring]` "));
  }
  
  if (!(HEX3DHEX3D__jsheaders95examples951_u13(Array.from(header_654311427.values()), ["value"]))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(15, 5) `header.values() == @[\"value\".cstring]` "));
  }
  
  if (!((header_654311427.get("key") == "value"))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(16, 5) `header[\"key\"] == \"value\".cstring` "));
  }
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(18, 5) `header[\"other\"] == \"another\".cstring` "));
  }
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(19, 5) `header.entries() ==\x0A    @[(\"key\".cstring, \"value\".cstring), (\"other\".cstring, \"another\".cstring)]` "));
  }
  
  if (!((JSON.stringify(Array.from(header_654311427.entries())) == "[[\"key\",\"value\"],[\"other\",\"another\"]]"))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(20, 5) `header.toCstring() == \"\"\"[[\"key\",\"value\"],[\"other\",\"another\"]]\"\"\".cstring` "));
  }
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(22, 5) `header.entries() == @[(\"key\".cstring, \"value\".cstring)]` "));
  }
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(24, 5) `header.entries() == @[]` "));
  }
  
  if (!((Array.from(header_654311427.entries()).length == 0))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(25, 5) `header.len == 0` "));
  }
...
Label2: {
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(32, 5) `header[\"key\"] == \"a, b, c\".cstring` "));
  }
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(34, 5) `header[\"key\"] == \"value\".cstring` "));
  }
...
Label3: {
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u84(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(40, 5) `header[\"key\"] == \"b\".cstring` "));
  }
